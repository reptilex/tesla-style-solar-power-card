...
// TODO You need to replace all instances of "action-handler-tesla-style-solar-power" with "action-handler-<your card name>"
customElements.define('action-handler-tesla-style-solar-power', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-tesla-style-solar-power')) {
    return body.querySelector('action-handler-boilerplattesla-style-solar-powere') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-tesla-style-solar-power');
