        ...
        <div id="tesla-style-solar-power-card">
          ...
          <div class="acc_center">
            <div class="acc_center_container">
              ...
              ${this.htmlWriter.writeAppliancePowerLineAndCircle(1,"M10,"+18*this.pxRate+" C10,"+18*this.pxRate+" 10,2 10,2")}
              ${this.writeApplianceIconBubble(2)}
              ${this.htmlWriter.writeAppliancePowerLineAndCircle(2,"M10,4 C10,4 10,"+17*this.pxRate+" 10,"+17*this.pxRate)}
            </div>
          </div>
