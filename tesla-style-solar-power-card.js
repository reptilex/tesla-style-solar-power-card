          ...
          <div class="acc_center">
            <div class="acc_center_container" 
              ...
              <div
                ...
                margin-left:${-.8*this.pxRate+"px"};
                margin-right:${-.8*this.pxRate+"px"}"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
