...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;function O(t){let e=B.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},B.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const s=t.strings.join(n);return i=e.keyString.get(s),void 0===i&&(i=new a(t,t.getTemplateElement()),e.keyString.set(s,i)),e.stringsArray.set(t.strings,i),i}const B=new Map,V=new WeakMap;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const nt={};class st extends K{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight(((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t)),i),i=e(t,new Set),n=[];i.forEach((t=>n.unshift(t))),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!X){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new et(String(e),tt)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?X?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==nt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return nt}}st.finalized=!0,st.render=(t,e,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const s=n.scopeName,o=V.has(e),r=U&&11===e.nodeType&&!!e.host,a=r&&!D.has(s),l=a?document.createDocumentFragment():e;if(((t,e,n)=>{let s=V.get(e);void 0===s&&(i(e,e.firstChild),V.set(e,s=new E(Object.assign({templateFactory:O},n))),s.appendInto(e)),s.setValue(t),s.commit()})(t,l,Object.assign({templateFactory:L(s)},n)),a){const t=V.get(l);V.delete(l);const n=t.value instanceof m?t.value.template:void 0;H(s,l,n),i(e,e.firstChild),e.appendChild(l),V.set(e,t)}!o&&r&&window.ShadyCSS.styleElement(e.host)};const ot={entities:{icon:"tune",name:"Entities",secondary:"Entities for card to make sense, none are required but you should have a few.",show:!1},actions:{icon:"gesture-tap-hold",name:"Actions",secondary:"Perform actions based on tapping/clicking",show:!1,options:{tap:{icon:"gesture-tap",name:"Tap",secondary:"Set the action to perform on tap",show:!1},hold:{icon:"gesture-tap-hold",name:"Hold",secondary:"Set the action to perform on hold",show:!1},double_tap:{icon:"gesture-double-tap",name:"Double Tap",secondary:"Set the action to perform on double tap",show:!1}}},appearance:{icon:"palette",name:"Appearance",secondary:"Customize the name, icon, etc",show:!1}};let rt=class extends st{constructor(){super(...arguments),this._initialized=!1,this._entityMap=new Map}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get home_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.home_entity)||""}get battery_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.battery_consumption_entity)||""}get grid_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.grid_entity)||""}get generation_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.generation_entity)||""}get home_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.home_entity)||""}get battery_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.battery_consumption_entity)||""}get grid_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.grid_entity)||""}get generation_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.generation_entity)||""}get grid_to_house_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.grid_to_house_entity)||""}get grid_to_battery_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.grid_to_battery_entity)||""}get battery_to_grid_in_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.battery_to_grid_entity)||""}get generation_to_grid_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.grid_to_battery_entity)||""}get generation_to_house_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.generation_entity)||""}get generation_to_battery_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.generation_yield_entity)||""}get appliance1_consumption_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.appliance1_consumption_entity)||""}get appliance1_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.appliance1_state_entity)||""}get appliance2_consumption_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.appliance2_consumption_entity)||""}get appliance2_extra_entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.appliance2_state_entity)||""}get show_w_not_kw(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_w_not_kw)||!1}get show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get hide_inactive_lines(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hide_inactive_lines)||!1}get tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"more-info"}}get hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){return this.hass&&this._helpers?(this._helpers.importMoreInfoControl("climate"),q`
      <div class="card-config">
        ...
        ${ot.entities.show?q`<div class="values">
              ${Array.from(this._entityMap).map((t=>{const e=t[0],i=this[`_${e}`];return q`
                  <ha-entity-picker
                    label="${e}"
                    @value-changed=${this._valueChanged}
                    .hass="${this.hass}"
        ...
        ${ot.actions.show?q`
              <div class="values">
                ...
                ${ot.actions.options.hold.show?q`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
                ...
                ${ot.actions.options.double_tap.show?q`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
    ...
    `}};var at;t([Z({attribute:!1})],rt.prototype,"hass",void 0),t([Q()],rt.prototype,"_config",void 0),t([Q()],rt.prototype,"_toggle",void 0),t([Q()],rt.prototype,"_helpers",void 0),rt=t([(at="tesla-style-solar-power-card-editor",t=>"function"==typeof t?((t,e)=>(window.customElements.define(t,e),e))(at,t):((t,e)=>{const{kind:i,elements:n}=e;return{kind:i,elements:n,finisher(e){window.customElements.define(t,e)}}})(at,t))],rt);class lt{constructor(t,e){this.speed=0,this.startPosition=0,this.currentPosition=0,this.currentDelta=0,this.maxPosition=30,this.unitOfMeasurement="",this.accText="",this.accTextclassName="accText",this.entity="",this.color="stroke:var(--info-color)",this.circleColor="var(--primary-color)",this.prevTimestamp=0,this.accTextElement=null,this.entity=t,this.entitySlot=e,this.value=0}setValueAndUnitOfMeasurement(t,e){if(void 0===t)return void(this.value=0);if(void 0===e)return void(this.value=t);const i=parseFloat(t);switch(e){case"W":case"kW":this.value=i,"kW"===e&&(this.value*=1e3),this.unitOfMeasurement="W",this.value=Math.round(this.value);break;case"%":this.value=i,this.unitOfMeasurement=e;break;default:this.value=t,this.unitOfMeasurement=e}}setSpeed(){this.speed=0,0!==Math.abs(this.value)&&(this.speed=lt.SPEEDFACTOR*this.value/1e3)}}lt.SPEEDFACTOR=.04;class ct{constructor(t,e){this.teslaCard=t,this.solarCardElements=t.solarCardElements,this.pxRate=t.pxRate,this.hass=e}writeBubbleDiv(t,e,i,n,s=null,o=null,r=null,a=null){return q` <div class="acc_td ${i}">
      <div
    ...
    .acc_center .acc_td.acc_appliance2 {
      position: absolute;
      right: 10px;
    `}}t([Z({attribute:!1})],dt.prototype,"hass",void 0),t([Q()],dt.prototype,"config",void 0),t([Z({attribute:!1})],dt.prototype,"solarCardElements",void 0),t([Q()],dt.prototype,"oldWidth",void 0),t([Z({type:String})],dt.prototype,"title",void 0),t([Z({type:Number})],dt.prototype,"counter",void 0),window.customElements.define("tesla-style-solar-power-card",dt)}();
