...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */}var st;null===(st=window.HTMLSlotElement)||void 0===st||st.prototype.assignedElements;class ot{constructor(t,e){this.speed=0,this.startPosition=0,this.currentPosition=0,this.currentDelta=0,this.maxPosition=30,this.unitOfMeasurement="",this.accText="",this.accTextclassName="accText",this.entity="",this.color="stroke:var(--info-color)",this.circleColor="var(--primary-color)",this.prevTimestamp=0,this.accTextElement=null,this.entity=t,this.entitySlot=e,this.value=0}setValueAndUnitOfMeasurement(t,e){if(void 0===t)return void(this.value=0);if(void 0===e)return void(this.value=t);const i=parseFloat(t);switch(e.toLowerCase()){case"w":case"kw":this.value=i,"kW"===e&&(this.value*=1e3),this.unitOfMeasurement="W",this.value=Math.round(this.value);break;case"wh":case"kwh":this.value=i,"kWh"===e&&(this.value*=1e3),this.unitOfMeasurement="Wh",this.value=Math.round(this.value);break;case"%":this.value=i,this.unitOfMeasurement=e;break;default:this.value=t,this.unitOfMeasurement=e}}setSpeed(t){if(this.speed=0,0===Math.abs(this.value))return;let e;e=void 0===t||t>1||t<=0?ot.SPEEDFACTOR:t,this.speed=e*this.value/1e3}}ot.SPEEDFACTOR=.04;class rt{constructor(){this.mainValue=0,this.clickEntitySlot=null,this.clickEntityHassState=null,this.noEntitiesWithValueFound=!0}}class lt{constructor(t,e){this.teslaCard=t,this.solarCardElements=t.solarCardElements,this.hass=e}writeBubbleDiv(t="",e){if(e.noEntitiesWithValueFound)return R``;t.length>0&&(t.startsWith(";")||(t="; "+t));const i=this.getSpaceBeforeUnit(e.extraUnitOfMeasurement),n=this.getSpaceBeforeUnit(e.mainUnitOfMeasurement);return R` <div class="acc_td ${e.cssSelector}" style="${t}">
      <div
        class="acc_container ${e.clickEntitySlot}"
        style="padding:0px"
        @click="${()=>this._handleClick(e.clickEntityHassState)}"
      >
        ${null!==e.extraValue?R` <div
    ...
    `)}writePowerLines(t){const e=this.dimensions.powerLinesHeight/2;let i;return i=void 0!==this.config.show_gap&&this.config.show_gap?2*this.dimensions.pxRate:0,R`
