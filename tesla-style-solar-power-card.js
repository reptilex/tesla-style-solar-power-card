    ...
    */
    ...
    `;
        ...
        _valueChanged(ev) {
            ...
            q(this, 'config-changed', { config: this._config }); // this is breaking the card built when terser is activated
        }
        _fillLineEntityMap() {
            if (this._config !== undefined) {
    ...
    class SensorElement {
        ...
        setValueAndUnitOfMeasurement(entityState, unitOfMeasurement) {
    ...
    class TeslaStyleSolarPowerCard extends LitElement {
        ...
        async performUpdate() {
            ...
            this.solarCardElements.forEach(solarSensor => {
                try {
                    solarSensor.setValueAndUnitOfMeasurement(this.hass.states[solarSensor.entity].state, this.hass.states[solarSensor.entity].attributes.unit_of_measurement);
    ...
    `;
        ...
        writeIconBubble(entitiesForMainValue, cssSelector, iconVariable, bubblClickEntitySlot = null, extraEntitySlot = null, isBatteryBubble = false) {
            ...
            entitiesForMainValue.forEach((entityHolder) => {
                ...
                if (divSolarElement !== null && (divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.value) !== undefined) {
                    oneDefinedEntity = true;
                    if (isSubstractionEntity) {
                        mainValue -= divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.value;
                    }
                    else {
                        mainValue += divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.value;
                    }
                    mainValue = ((mainValue * 100) | 0) / 100;
                    mainUnitOfMeasurement = divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.unitOfMeasurement;
                }
        ...
        colourHouseBubbleDependingOnHighestInput() {
            ...
            houseEntities.forEach(entityHolder => {
                const divSolarElement = this.solarCardElements.get(entityHolder);
                if (divSolarElement !== null && (divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.value) !== undefined) {
                    if (highestEntity == null || (divSolarElement === null || divSolarElement === void 0 ? void 0 : divSolarElement.value) > highestEntity.value) {
